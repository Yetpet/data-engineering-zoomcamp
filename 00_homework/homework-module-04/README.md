...
```
--12,184
SELECT count(*) FROM  kestra-sandbox-486103.dbt_yetpet.fct_monthly_zone_revenue
```
...
from dbt_yetpet.fct_monthly_zone_revenue
...
select
count(*)
from kestra-sandbox-486103.dbt_yetpet.stg_fhv_tripdata 
```
